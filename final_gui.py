...
def show_segment():
	global adj
	img1,adj,color,nodes=gaps_close(groundfilled_img,filename,new_filename,text1)
	img2=np.array(img1)
...
# header3 = Image.open("graph.tiff")
# header3 = header3.resize((200, 200), Image.ANTIALIAS)
# header4 = ImageTk.PhotoImage(image=header3)
...
tk.Button(root, text = "GRAPH", command = lambda: show_graph(np.array(adj),text2,root,color,nodes), height=1,width=45 , fg="white",bg="#574395", activebackground="#6f602a").place(x=1120,y=640)
